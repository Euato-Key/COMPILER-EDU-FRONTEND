    ...
    >
      ...
      <div v-else class="space-y-4">
        ...
        >
          ...
          <!-- AI消息 -->
          <div v-else-if="message.role === 'assistant'" class="flex items-start gap-2 max-w-[80%] animate-fade-in">
            ...
            <div class="flex-1 min-w-0">
              <div class="bg-gray-100 text-gray-900 px-4 py-2 rounded-2xl rounded-bl-md shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
        ...
        <!-- 流式输出 -->
        <div v-if="isStreaming" class="flex items-start gap-2 max-w-[80%] animate-fade-in">
          ...
          <div class="flex-1 min-w-0">
            <div class="bg-gray-100 text-gray-900 px-4 py-2 rounded-2xl rounded-bl-md shadow-sm border-l-4 border-purple-400">
