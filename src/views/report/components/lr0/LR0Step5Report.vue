            ...
            <thead>
              <tr class="bg-gray-50 text-gray-500 uppercase tracking-wider text-xs">
                ...
                <th class="px-4 py-3 text-left border w-1/4">
                  <div class="flex items-center gap-2">
                    <span>用户答案</span>
                    <span class="text-[10px] bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded">状态栈</span>
                  </div>
                </th>
                <th class="px-4 py-3 text-left border w-1/4">
                  <div class="flex items-center gap-2">
                    <span>用户答案</span>
                    <span class="text-[10px] bg-purple-100 text-purple-600 px-1.5 py-0.5 rounded">符号栈</span>
                  </div>
                </th>
                <th class="px-4 py-3 text-left border w-1/4">
                  <div class="flex items-center gap-2">
                    <span>用户答案</span>
                    <span class="text-[10px] bg-pink-100 text-pink-600 px-1.5 py-0.5 rounded">输入串</span>
                  </div>
                </th>
...
const rows = computed<RowData[]>(() => {
  ...
  const standardActions = result.info_action || []
