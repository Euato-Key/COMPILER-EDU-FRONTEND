<template>
  <div class="lr0-step5-report space-y-8">
    <!-- 步骤5标题 -->
...
const rows = computed<RowData[]>(() => {
  ...
  const standardInputStrings = props.inputAnalysisResult.info_str || []
  const standardActions = props.inputAnalysisResult.info_action || props.inputAnalysisResult.info_msg || []
